  ...
  <ul class="menu">
     ...
     <%
      if(session.getAttribute("users")!=null)
      {
          ...
          <li><a id="logout-btn" class="logout-btn" data-url ="<%= request.getContextPath()+"/customer/logout"%>"  onclick="handleLogoutClick()"><i class="ri-logout-box-line"></i> Logout</a></li>
    	  <%
  ...
  <div class="menu-sider menu-sider-close ">
     ...
     <%
      if(session.getAttribute("users")!=null)
      {
          ...
          <li><a href="<%= request.getContextPath()+"/customer/Orders.jsp"%>" class="<%= selectedMenu.equals("Orders") ? "desktop-menu-active" : ""%>"><i class="ri-shopping-bag-line"></i> Orders</a></li>
          <li><a  class="logout-btn"  onclick="handleLogoutClick()"><i class="ri-logout-box-line"></i> Logout</a></li>
    	  <%
