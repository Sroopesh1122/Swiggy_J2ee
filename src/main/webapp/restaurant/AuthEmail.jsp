...
<section class="section-wrapper">
    ...
    <h1 class="quote">Your kitchen, your rules. Sign in to take charge.</h1>

    <img alt="" class="img-overlay" src="https://img.freepik.com/premium-photo/cook-chef-with-big-explosion-kitchen_207634-3621.jpg"%>">
     <div class="shadow-overlay"></div>
		...
		<article class="email-form-wrapper">
			...
			<footer class="footer-1 mt-4">
			  ...
			  <p>Already have an account? <a href="<%=request.getContextPath()+"/restaurant/SignIn.jsp"%>">SignIn</a> </p>
...
const redirectUrl = '<%=request.getContextPath()+"/restaurant/SignUp.jsp"%>'
